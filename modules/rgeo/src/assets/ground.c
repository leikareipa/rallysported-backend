...
{
    k_assert((groundIdx <= 8), "Ground index out of bounds.");
    ...
    // Import the Rally-Sport heightmap.
    {
        ...
        k_assert(((HEIGHTMAP_WIDTH == 64) || (HEIGHTMAP_WIDTH == 128)), "Unsupported heightmap dimensions.");
    ...
    // Import the Rally-Sport tilemap.
    {
        ...
        k_assert((sqrt(kfile_file_size(varimaaHandle)) == HEIGHTMAP_WIDTH), "Invalid tilemap dimensions.");
    ...
    // Load prop locations.
    {
        ...
        switch (groundIdx)
        {
            ...
            default: k_assert(0, "Invalid track index."); break;
        }
        ...
        k_assert((NUM_PROPS <= MAX_NUM_PROPS), "The number of track props would overflow.");
